...
@section('title', 'Tambah Nasabah - Bank Sampah')
@section('page-title', 'Tambah Nasabah Bank Sampah')
...
<div class="card border-0 shadow-sm" style="border-radius: 16px;">
    <div class="card-header bg-white border-0" style="border-radius: 16px 16px 0 0; padding: 20px 24px;">
        <h5 class="mb-0 fw-bold"><i class="fas fa-plus-circle text-success me-2"></i>Form Tambah Nasabah</h5>
    </div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select id="warga_select" name="warga_id" class="form-control">
                        ...
                        @foreach($wargas as $w)
                        <option value="{{ $w->id }}" data-nik="{{ $w->nik }}" data-alamat="{{ e($w->alamat) }}" data-nohp="{{ $w->no_hp }}">{{ $w->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Nama Nasabah <span class="text-danger">*</span></label>
                    <input type="text" id="nama_nasabah" name="nama_nasabah" class="form-control" value="{{ old('nama_nasabah') }}" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    ...
                    <input id="berat_sampah" type="number" step="0.01" min="0" name="berat_sampah" class="form-control" value="{{ old('berat_sampah', 0) }}" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="tanggal_setoran" class="form-control" value="{{ old('tanggal_setoran', date('Y-m-d')) }}">
                </div>
                <div class="col-12">
